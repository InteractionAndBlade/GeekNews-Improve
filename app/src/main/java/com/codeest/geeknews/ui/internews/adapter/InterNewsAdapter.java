package com.codeest.geeknews.ui.internews.adapter;
...
public class InterNewsAdapter extends RecyclerView.Adapter<InterNewsAdapter.ViewHolder> {

    private Context mContext;
    private LayoutInflater inflater;
    private List<WXItemBean> mList;

    public InterNewsAdapter(Context mContext, List<WXItemBean> mList) {
